...
void playRickRoll()
{
    ...
    int index = 0;
    int numNotes = 50;
    unsigned char notes[] = {62, 64, 67, 64, 59, 59, 57, 62, 64, 67, 64, 57, 57, 67, 62, 64, 67, 64, 67, 57, 66, 62, 62, 57, 67, 62, 64, 67, 64, 59, 59, 57, 62, 64, 67, 64, 74, 66, 67, 0, 62, 64, 67, 64, 59, 57, 66, 62, 57, 67};


    unsigned char duration[] = {16, 16, 16, 16, 32, 32, 32, 16, 16, 16, 16, 32, 32, 32, 16, 16, 16, 16, 32, 32, 32, 32, 32, 32, 62, 32, 32, 16, 16, 16, 16, 64, 16, 16, 16, 16, 32, 16, 32, 32, 32, 16, 16, 16, 16, 32, 32, 32, 32, 16};
    oi_loadSong(index, numNotes, notes, duration);
    oi_play_song(index);
    free(sensor_data);
}
...
void playMarioSoundEffect()
{
    ...
    int index = 0;
    int numNotes = 9;
    unsigned char notes[9] = {84, 83, 81, 79, 78, 76, 79, 78, 76};
    unsigned char duration[9] = {8, 8, 16, 16, 16, 32, 16, 16, 32};
    oi_loadSong(index, numNotes, notes, duration);
    oi_play_song(index);
    free(sensor_data);
}
